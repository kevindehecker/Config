...
/home/kevin/caffe/build/tools/caffe train -solver solver_autoconfigure.prototxt -weights model_norm_abs_100k.caffemodel -gpu 1 2>&1 | tee $snapdir/logfile.log
