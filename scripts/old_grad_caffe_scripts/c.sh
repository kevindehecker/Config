...
#parallel --max-procs 2 --ungroup  <<EOF
	...
	./b.sh secondgt $resolution $experimentname $lr $maxiter $weightDecay $momentum $stepiter turnlogs $stride1 $stride2 $stride3 $numout1 $numout2 $numout3 $numout4  $stride0
    #./b.sh secondgt $resolution $experimentname $lr $maxiter $weightDecay $momentum $stepiter turnlogs $stride1 $stride2 $stride3 $numout1 $numout2 $numout3 $numout4  $stride0
